      ...
      <div class="card-body p-4">
        <form method="post"
          ...
          <div class="row g-3">
            <!-- Service Number -->
            <div class="col-md-8">
              <label class="form-label fw-semibold">Service Number <span class="text-danger">*</span></label>
              <input type="text" name="service_number" class="form-control"
                     placeholder="e.g. 12345"
                     value="<?= htmlspecialchars($old['service_number'] ?? '') ?>"
                     required>
            </div>
            <!-- Name -->
            <div class="col-md-8">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="formation" class="form-control"
                     ...
                     value="<?= htmlspecialchars($old['formation'] ?? '') ?>">
            </div>
    ...
    <div class="card border-0 shadow-sm">
      ...
      <div class="card-body p-0">
        ...
        $roleDescriptions = [
          ...
          'g_staff'            => 'General staff review role. Reviews and approves CPO submissions for formation.',
          'formation_commander'=> 'Formation-level commander. Reviews G Staff approved incidents and endorses for HQ.',
          'cpo'                => 'Command Post Officer. Creates provincial incidents for their formation.',
          ...
          'army_hq'            => 'Army HQ. Final consolidated reporting and analytics access.',
        ];
        foreach ($roles as $r):
